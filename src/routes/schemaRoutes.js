 ...
 * @class UpdateMany
 */
class UpdateMany extends Route {
	constructor(schema, appShort) {
	...
	_validate(req, res, token) {
		if (!Array.isArray(req.body)) {
			...
			return Promise.reject(new Helpers.RequestError(400, `${this.schema.name}: Expected body to be an array of updates`));
		}
